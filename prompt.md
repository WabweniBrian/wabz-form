The following code snippets are used to build a simple form builder. Study them and help add another field called "MultiCheck" to the form builder. The "MultiCheck" field should be a checkbox that allows multiple selections.
...
function DesignerComponent({
  ...
  const { label, placeholder, required, helperText } = elements.extraAttributes;
