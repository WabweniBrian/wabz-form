    ...
    <div className="flex w-full h-full">
      ...
      >
        <div
          ...
          className={cn(
            "bg-background max-w-[1000px] h-full mx-auto rounded-xl flex-align-center flex-col justify-start flex-1 overflow-y-auto",
            droppable.isOver && "ring-2 ring-primary"
          )}
        >
          {!droppable.isOver && elements.length === 0 && (
            <p className="text-3xl text-muted-foreground flex-align-center flex-grow font-bold">
              Drop Here
            </p>
          )}
          {droppable.isOver && elements.length === 0 && (
